...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	$club_id=$row[0];
	$a="SELECT fest_name from create_fest WHERE fest_name='$fest_name'";
	...
	{
		$sql="INSERT INTO create_fest (club_id,date_cur,time_cur,end_time,fest_name,place,more_info,invite) VALUES ('$club_id','$date_cur','$time_cur','$end_time','$fest_name','$place','$more_info','$invite')"; //Inserts the value to table registration
		echo "<script>setTimeout(\"location.href = '../../admin/html/admin.html';\",500);</script>";
