...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2018 at 06:55 PM
...
CREATE TABLE `register_fest_event` (
  `register_fest_event_id` int(11) NOT NULL,
  `fest_event_id` int(11) NOT NULL,
  `student_id` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `register_fest_event`
  ADD PRIMARY KEY (`register_fest_event_id`),
  ADD KEY `fest_event_id` (`fest_event_id`);
...
--
ALTER TABLE `create_fest`
  MODIFY `fest_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
-- AUTO_INCREMENT for table `create_fest_event`
--
ALTER TABLE `create_fest_event`
  MODIFY `fest_event_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `register_event`
--
ALTER TABLE `register_event`
  MODIFY `register_event_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `register_fest_event`
--
ALTER TABLE `register_fest_event`
  MODIFY `register_fest_event_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `create_fest_event`
  ADD CONSTRAINT `create_fest_event_ibfk_1` FOREIGN KEY (`club_id`) REFERENCES `club` (`Club_ID`),
  ADD CONSTRAINT `create_fest_event_ibfk_2` FOREIGN KEY (`fest_id`) REFERENCES `create_fest` (`fest_id`);
...
--
-- Constraints for table `register_fest_event`
--
ALTER TABLE `register_fest_event`
